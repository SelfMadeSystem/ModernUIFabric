...
final class Config {
    ...
    public static class Client {
        ...
        private void reload() {
            ...
            ModernUIFabric.sInventoryScreenPausesGame = inventoryPause.get();
            TooltipRenderer.sTooltip = !ModernUIFabric.hasGLCapsError() && tooltip.get();
    ...
    public static class Common {
        ...
        private void reload() {
            ModernUIFabric.sDeveloperMode = developerMode.get();
